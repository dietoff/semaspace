 ...
 */
public class SwingSema7 implements SemaListener, KeyListener {
	/**
	 * Launches this application
	 */
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			private SwingSema7 application;
	...
	private void enterFullscreen() {
		...
		mainWindow.setBounds(0, 0, 1000, 600);
	...
	private JCheckBox getClusters() {
		if (clusters == null) {
			...
			clusters.setBounds(46, 229, 60, 17);
	...
	private JSplitPane getControlPane() {
		if (jSplitPane1 == null) {
			...
			jSplitPane1.setPreferredSize(new java.awt.Dimension(230, 600));
			jSplitPane1.setDebugGraphicsOptions(DebugGraphics.NONE_OPTION);
			jSplitPane1.setMaximumSize(new java.awt.Dimension(230, 2147483647));
	...
	private JLabel getDepthLabel() {
		if (depthLabel == null) {
			...
			depthLabel.setBounds(144, 81, 61, 13);
		}
		return depthLabel;
	}
	...
	private JPanel getDummyPanel() {
		if (dummyPanel == null) {
			...
			dummyPanel.setPreferredSize(new java.awt.Dimension(750, 600));
			dummyPanel.setMinimumSize(new java.awt.Dimension(600, 600));
	...
	private SimButton getElimButton1() {
		if (elimButton1 == null) {
			...
			elimButton1.setBounds(73, 176, 67, 15);
	...
	private SimButton getExpand2() {
		if (expand2 == null) {
			...
			expand2.setBounds(144, 119, 67, 15);
	...
	private SimButton getExpandnet() {
		if (expandnet == null) {
			...
			expandnet.setBounds(2, 119, 67, 15);
	...
	private JCheckBox getFadeLabelsBox() {
		if(fadeLabels == null) {
			...
			fadeLabels.setBounds(49, 1, 51, 17);
	...
	private JCheckBox getForceBox() {
		if (forceBox == null) {
			...
			forceBox.setBounds(173, 1, 51, 17);
	...
	private JLabel getJLabel13() {
		if(jLabel13 == null) {
			...
			jLabel13.setBounds(2, 100, 210, 14);
		}
		return jLabel13;
	}
	...
	private JLabel getJLabel2() {
		if (jLabel2 == null) {
			...
			jLabel2.setBounds(1, 138, 212, 14);
		}
		return jLabel2;
	}
	...
	private JLabel getJLabel7() {
		if(jLabel7 == null) {
			...
			jLabel7.setBounds(144, 212, 49, 13);
		}
		return jLabel7;
	}
	...
	private JSlider getJSlider1() {
		if(jSlider1 == null) {
			...
			jSlider1.setBounds(0, 195, 140, 35);
	...
	public JSplitPane getJSplitPane() {
		if (jSplitPane == null) {
			...
			jSplitPane.add(getControlPane(), JSplitPane.RIGHT);
			jSplitPane.add(getDummyPanel(), JSplitPane.LEFT);
	...
	private SimButton getRandomCenter() {
		if (randomCenter == null) {
			...
			randomCenter.setBounds(73, 47, 67, 15);
	...
	private SimButton getSeachSelButton() {
		if (seachSelButton == null) {
			...
			seachSelButton.setBounds(144, 47, 67, 15);
	...
	private JTextField getSearchTerm() {
		if (searchTerm == null) {
			...
			searchTerm.setBounds(2, 19, 138, 24);
			searchTerm.setFont(new java.awt.Font("Dialog",0,16));
	...
	private SimButton getSimButton1() {
		if(simButton1 == null) {
			...
			simButton1.setBounds(2, 157, 67, 15);
	...
	private SimButton getSimButton14() {
		if(simButton14 == null) {
			...
			simButton14.setBounds(73, 119, 67, 15);
	...
	private SimButton getSimButton2() {
		if (SimButton2 == null) {
			...
			SimButton2.setBounds(2, 176, 67, 15);
	...
	private SimButton getSimButton7() {
		if(simButton7 == null) {
			...
			simButton7.setBounds(144, 176, 67, 15);
	...
	private SimButton getSimButton8() {
		if(simButton8 == null) {
			...
			simButton8.setBounds(73, 157, 67, 15);
	...
	private SimButton getSimButton9() {
		if(simButton9 == null) {
			...
			simButton9.setBounds(144, 157, 67, 15);
	...
	private JCheckBox getTimelineBox() {
		if (timeBox == null) {
			...
			timeBox.setBounds(109, 229, 61, 17);
	...
	private JCheckBox getTreeBox() {
		if (treeBox == null) {
			...
			treeBox.setBounds(173, 229, 49, 17);
