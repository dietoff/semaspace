...
public class BerlinAusstSema implements SemaListener, KeyListener {
	/**
	 * Launches this application
	 */
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			private BerlinAusstSema application;
	...
	private JSplitPane getAttributeSplitPane1() {
		if(AttributeSplitPane1 == null) {
			...
			AttributeSplitPane1.setPreferredSize(new java.awt.Dimension(226, 183));
	...
	private JCheckBox getClusters() {
		if (clusters == null) {
			...
			clusters.setBounds(149, 232, 59, 17);
	...
	private JList getEdgeAttList() {
		if(edgeAttList == null) {
			...
			edgeAttList.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JScrollPane getEdgeAttPane() {
		if(edgeAttPane == null) {
			...
			edgeAttPane.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JCheckBox getFadeLabelsBox() {
		if(fadeLabels == null) {
			...
			fadeLabels.setBounds(149, 216, 60, 17);
...
//			file.add(getRemoveSel());
	...
	private JCheckBox getForceBox() {
		if (forceBox == null) {
			...
			forceBox.setBounds(69, 231, 78, 17);
	...
	private JLabel getJLabel14() {
		if(jLabel14 == null) {
			...
			jLabel14.setBounds(0, 254, 210, 14);
		}
		return jLabel14;
	}
	...
	private JLabel getJLabel7() {
		if(jLabel7 == null) {
			...
			jLabel7.setBounds(148, 269, 74, 34);
		}
		return jLabel7;
	}
	...
	private JSlider getJSlider1() {
		if(jSlider1 == null) {
			...
			jSlider1.setBounds(0, 268, 136, 25);
...
//			nodeset2 = app.fileIO.getPage("http://www2.hu-berlin.de/facingscience/accounts/csv/disciplinenodes.php");
			...
			File ns1 = new File("data/facingscience.tab.n"); //$NON-NLS-1$
			if (ns1.exists()) 	nodeset1 = FileIO.loadFile(ns1);
			File ns2 = new File("data/disciplines.tab.n"); //$NON-NLS-1$
			if (ns2.exists()) 	nodeset2 = FileIO.loadFile(ns2);
...
//			nodeset2 = app.fileIO.getPage("http://www.facingscience.net/disciplines.tab.n");
	...
	private JList getNodeAttList() {
		if(nodeAttList == null) {
			...
			nodeAttList.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JList getNodeList() {
		if (nodeList == null) {
			...
			nodeList.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JList getNodeActivitiesList() {
		if (nodeActivitiesList == null) {
			...
			nodeActivitiesList.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JList getNodePersonsList() {
		if (nodePersonsList == null) {
			...
			nodePersonsList.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JList getNodePlacesList() {
		if (nodePlacesList == null) {
			...
			nodePlacesList.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JList getRolesList() {
		if (rolesList == null) {
			...
			rolesList.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JScrollPane getNodeAttPane() {
		if(nodeAttPane == null) {
			...
			nodeAttPane.setFont(new java.awt.Font("Dialog",0,16));
...
//		app.p.setAttribute(attribute);
	...
	private JScrollPane getNodesActivities() {
		...
		if (nodesActivities == null) {
			...
			nodesActivities.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JScrollPane getNodesPersons() {
		...
		if (nodesPersons == null) {
			...
			nodesPersons.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JScrollPane getNodesPlaces() {
		...
		if (nodesPlaces == null) {
			...
			nodesPlaces.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JScrollPane getRoles() {
		...
		if (roles == null) {
			...
			roles.setFont(new java.awt.Font("Dialog",0,16));
	...
	private JCheckBox getRadbox() {
		if(radLabels == null) {
			...
			radLabels.setBounds(69, 216, 72, 14);
	...
	private SimButton getSimButton4() {
		if(simButton4 == null) {
			...
			simButton4.setBounds(2, 178, 65, 29);
	...
	private SimButton getSimButton5() {
		if(simButton5 == null) {
			...
			simButton5.setBounds(72, 178, 80, 29);
	...
	private SimButton getSimButton20() {
		if(simButton20 == null) {
			...
			simButton20.setBounds(157, 178, 65, 29);
	...
	private SimButton getSimButton22() {
		if(simButton22 == null) {
			...
			simButton22.setBounds(2, 64, 219, 25);
	...
	private SimButton getSimButton23() {
		if(simButton23 == null) {
			...
			simButton23.setBounds(2, 38, 219, 25);
	...
	private SimButton getSimButton24() {
		if(simButton24 == null) {
			...
			simButton24.setBounds(2, 12, 219, 25);
	...
	private SimButton getSimButton25() {
		if(simButton25 == null) {
			...
			simButton25.setBounds(2, 90, 219, 25);
	...
	private JPanel getJPanel1() {
		if(jPanel1 == null) {
			...
			jPanel1.setBounds(4, 120, 210, 34);
